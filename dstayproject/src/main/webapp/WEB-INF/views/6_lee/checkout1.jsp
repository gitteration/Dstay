		...
		<div class="col-md-4" style="display: inline-block; width: 300px;">
                <div class="box-bg-white hidden-xs" style="margin-bottom: 0px;">
                    <div class="row">
						 ...
						 <a id="markSpBtn" class="btn pull-right button-green-top-nav" style="width:50%;" >지정배송지(1)</a>
						 <span><a id="recentlySpBtn" class="btn pull-right button-green-top-nav" style="width:50%;" onclick="">최근배송지(1)</a></span>
